...
const FooterButton = ({ title }) => {
  return (
    <button className="text-white py-1.5 px-5 rounded-none hover:bg-gray-700 transition-all duration-300 hover:rounded cursor-pointer">
      {title}
    </button>
  );
};
...
const Footer = () => {
  return (
    <footer className="bg-gray-900 text-white pb-12 mt-16">
      <div className=" top-footer text-center py-6 w-full flex flex-col justify-center items-center gap-1 bg-gray-800 border-t-2 border-gray-600 sm:flex-row">
        <FooterButton title="Contact Us" />
        <FooterButton title="Privacy Policy" />
        <FooterButton title="Terms of Service" />
      </div>
      <div className="container mx-auto text-center flex flex-col items-center mt-8 gap-4">
        <a href="https://www.riotgames.com/en">
          <svg
            width="99"
            height="32"
            viewBox="0 0 587.93 165"
            className="fill-gray-400 hover:fill-gray-100 transition-colors duration-200"
          >
        ...
        <p className="text-xs text-gray-400 max-w-88">
          ™ & &copy; {new Date().getFullYear()} Riot Games, Inc. League of
          Legends and all related logos, characters, names and distinctive
          likenesses thereof are exclusive property of Riot Games, Inc. All
          Rights Reserved.
        </p>
      </div>
      <div className="bottom-footer container mx-auto text-center flex justify-center items-center space-x-4 mt-8">
        <a
          href="https://github.com/MollyLaMolla"
          className="flex items-center justify-center gap-2 w-fit px-5 py-1.5 rounded-none hover:bg-gray-700 transition-all duration-300 hover:rounded"
        >
          <FaGithub size={24} />
          GitHub
        </a>
